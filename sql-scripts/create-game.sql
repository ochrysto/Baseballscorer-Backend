...
VALUES (null, '2024-07-06', null, 74, 9, null, 1, null, 6, 7, 2, 1, 2, 'Bremen');

INSERT INTO public.game_state
VALUES (0, 0, 0, 0, 0, 0, 0, 0, 2, 2);

INSERT INTO public.inning
VALUES (1, 0, 0, 2, 0, 'AWAY');
...
INSERT INTO public.lineup_team_player
VALUES (11, 1, 1, 1, 21),
       (22, 2, 1, 2, 22),
       (33, 3, 1, 3, 26),
       (44, 4, 1, 4, 25),
...
INSERT INTO public.turn
VALUES (0, 0, 0, 0, 0, 10, 'AT_BAT');  -- We cannot use ID 1 because spring boot is than angry :(
