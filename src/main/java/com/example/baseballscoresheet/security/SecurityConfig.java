...
import com.example.baseballscoresheet.keycloak.KeycloakLogoutHandler;
...
class SecurityConfig {
    ...
    public GrantedAuthoritiesMapper userAuthoritiesMapperForKeycloak() {
        return authorities -> {
            ...
            // check for the type of token and decides on parsing mechanism
            if (isOidc) {
    ...
    Collection<GrantedAuthority> generateAuthoritiesFromClaim(Collection<String> roles) {
        /**
         * Adds `ROLE_` prefix to each role retrieved from Keycloak
         */
